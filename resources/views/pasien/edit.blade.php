        ...
        <div class="container p-4">
            <form action="{{ route('pasiens.update', $pasien->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="NIK" value="{{ $pasien->NIK }}" name="NIK">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="tempat_lahir" value="{{ $pasien->tempat_lahir }}"
                        name="tempat_lahir">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="diagnosis_lab" value="{{ $pasien->diagnosis_lab }}"
                        name="diagnosis_lab">
                </div>
                <div class="mb-3">
                    <label for="diagnosis_klinis" class="form-label">Diagnosis Klinis</label>
                    <input type="text" class="form-control" id="diagnosis_klinis"
                        value="{{ $pasien->diagnosis_klinis }}" name="diagnosis_klinis">
                </div>
                <div class="mb-3">
                    <label for="status_akhir" class="form-label">Status Akhir</label>
                    <input type="text" class="form-control" id="status_akhir" value="{{ $pasien->status_akhir }}"
                        name="status_akhir">
                </div>
                <div class="mb-3">
